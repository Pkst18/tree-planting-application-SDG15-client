...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<void> _pickQRCode() async {
    try {
      // Simulate QR code file selection
      // In a real app, you would use image_picker or similar
      setState(() {
        qrCodeFileName = 'qrcode_${DateTime.now().millisecondsSinceEpoch}.png';
      });
    } catch (e) {
      _showErrorDialog('Failed to pick QR code: ${e.toString()}');
    }
  }
  ...
  Future<void> _register() async {
    ...
    if (selectedRole == 'Planter' && qrCodeFileName == null) {
      _showErrorDialog('Please upload a QR code for planter role');
      return;
    }
